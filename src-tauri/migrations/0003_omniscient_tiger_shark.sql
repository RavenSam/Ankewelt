...
INSERT INTO `__new_chapter`("id", "book_id", "group_id", "position", "root_position", "title", "chapter_number", "word_count", "status", "current_version_id", "created_at", "updated_at") SELECT "id", "book_id", "group_id", "position", "root_position", "title", "chapter_number", "word_count", "status", "current_version_id", "created_at", "updated_at" FROM `chapter`;--> statement-breakpoint
...
ALTER TABLE `chapter_group` ADD `collapsed` integer DEFAULT false NOT NULL;